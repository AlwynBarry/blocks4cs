	 ...
	 */
	 public function display() : string {
        ...
        $output = '<div'
					...
					. ' class="b4cs-card b4cs-compact-event b4cs-event-status-' . $this->cs_event->get_status() . '">' . "\n";
		
		// Display the event time and the end time if provided
        if ( $this->cs_event->is_start_date() ) {
            $output .= '    <div class="b4cs-time"><span class="b4cs-start-time">' . date_format( $this->cs_event->get_start_date(), 'g:ia' ) . '</span>';
